      ...
      <motion.div style={{ opacity, y, scale }} className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-square rounded-lg overflow-hidden border border-tech-gold/20 shadow-xl shadow-tech-red/5 tech-panel">
              <Image
                src="/about.png"
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-tech-red to-tech-gold rounded-full opacity-10 blur-2xl" />
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              Front-End Developer with 3 years of experience crafting high-performance, responsive interfaces using React.js
              and Next.js. Proven ability to optimize complex workflows. Skilled in performance tuning, cross-functional collaboration,
              and upholding high code quality standards through pull request reviews.
            </p>
            <div className="flex flex-wrap gap-2">
              <Badge variant="outline" className="bg-tech-red/10 text-tech-red border-tech-red/20">
                React
              </Badge>
              <Badge variant="outline" className="bg-tech-gold/10 text-tech-gold border-tech-gold/20">
                Next.js
              </Badge>
              <Badge variant="outline" className="bg-tech-red/10 text-tech-red border-tech-red/20">
                Javascript
        ...
        <div className="mt-24">
          ...
          <div className="space-y-12">
            {experiences.map((exp, index) => (
              ...
              >
                <div className="absolute -left-1.5 top-0 w-3 h-3 rounded-full bg-gradient-to-r from-tech-red to-tech-gold" />
