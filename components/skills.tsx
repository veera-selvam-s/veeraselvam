    ...
    <div ref={containerRef} className="container mx-auto px-4">
      <motion.div style={{ opacity, y }} className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="rounded-lg overflow-hidden border border-tech-gold/20 tech-panel">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {["React", "Next.js", "TypeScript", "JavaScript", "HTML5", "CSS3"].map((tech, i) => (
                      <motion.div
                        ...
                        viewport={{ once: true }}
                        className="px-3 py-1.5 rounded-md bg-tech-red/10 text-tech-red text-sm"
                      >
                        {tech}
                      </motion.div>
                    ))}
                  ...
                  <div className="flex flex-wrap gap-3">
                    {["Tailwind CSS", "Styled Components", "Framer Motion", "Figma", "Adobe XD"].map((tech, i) => (
                      <motion.div
                        ...
                        transition={{ duration: 0.3, delay: i * 0.1 }}
                        viewport={{ once: true }}
                        className="px-3 py-1.5 rounded-md bg-tech-gold/10 text-tech-gold text-sm"
                      >
                        {tech}
                      </motion.div>
                    ))}
